...
//                .requestMatchers("/user/javainuse-openapi/**").permitAll()
//                .requestMatchers("/user/swagger-ui.html", "/swagger-ui/**", "/swagger-resources/**", "/swagger-resources", "/v3/api-docs/**", "/proxy/**").permitAll()
//                .requestMatchers("/user/resources/**", "/static/**", "/css/**", "/js/**", "/images/**").permitAll()
//                .requestMatchers("/user/register/**").permitAll()
//                .requestMatchers("/user/images/**").permitAll()
//                .requestMatchers("/user/cron/**").permitAll()
//                .requestMatchers("/user/api/**").permitAll()
//                .requestMatchers("/user/info/**").permitAll()
//                .requestMatchers("/user/awizacje/**").permitAll()
//                .requestMatchers("/user/przepustki/**").permitAll()
//                .requestMatchers("/user/softwares/**").permitAll()
//                .requestMatchers("/user/dashboards/**").permitAll()
